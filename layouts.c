const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_planck_grid( // {{{
        ...
        KC_F18,  KC_LCMD, LOWER,   KC_LCTL, KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_RSFT, RAISE,   KC_RALT, KC_F19
    ), // }}}
    ...
    [_FNCTN] = LAYOUT_planck_grid( // {{{
        ...
        XXXXXXX, XXXXXXX, KC_MPLY ,KC_F13,  KC_F16,  XXXXXXX, XXXXXXX, KC_F10,  KC_F1,   KC_F2,   KC_F3,   ORS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ), // }}}
    ...
    [_ADJUST2] = LAYOUT_planck_grid( // {{{
        ...
        XXXXXXX, XXXXXXX, KO_TOGG, EE_CLR,  XXXXXXX, XXXXXXX, XXXXXXX, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, RGB_M_TW,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
    ), // }}}

    [_MOUSE] = LAYOUT_planck_grid( // {{{
        _______, KC_WH_D, KC_MS_U, KC_WH_U, KC_BTN3, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN3, KC_BTN2, XXXXXXX, XXXXXXX,
        XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN5, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
