const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_planck_grid( // {{{
        KC_ESC,  KC_W,    KC_F,    KC_P,    KC_V,    SHWINFO, NEWWIN,  KC_J,    KC_L,    KC_U,    KC_Y,    KC_Q,
        KC_A,    KC_R,    KC_S,    KC_T,    KC_G,    NEWFLDR, DELFILE, KC_H,    KC_N,    KC_E,    KC_I,    KC_O,
        KC_Z,    KC_X,    KC_C,    KC_D,    KC_B,    KC_LSFT, TOGHDDN, KC_K,    KC_M,    KC_COMM, KC_DOT,  KC_SCLN,
        FNCTN,   KC_LCMD, LOWER,   KC_LCTL, KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  KC_RSFT, RAISE,   KC_RALT, MOUSE
    ), // }}}
    ...
    [_LOWER] = LAYOUT_planck_grid( // {{{
        SC_TAB,  KC_MINS, KC_EQL,  KC_QUOT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_7,    KC_8,    KC_9,    KC_BSPC,
        MOD_CAG, KC_SLSH, KC_LBRC, KC_RBRC, KC_GRV,  XXXXXXX, XXXXXXX, KC_0,    KC_4,    KC_5,    KC_6,    XXXXXXX,
        KC_LCTL, KC_SCLN, KC_COMM, KC_DOT,  KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ), // }}}
    ...
    [_RAISE] = LAYOUT_planck_grid( // {{{
        ...
        XXXXXXX, KC_COLN, KC_LABK, KC_RABK, KC_PIPE, XXXXXXX, XXXXXXX, XXXXXXX, KC_EXLM, KC_AT,   KC_HASH, XXXXXXX,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ), // }}}
    ...
    [_ADJUST] = LAYOUT_planck_grid( // {{{
        EXT_LYR, KO_WDDL, KO_WD,   XXXXXXX, KO_CMDV, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KO_CTLU, XXXXXXX, KO_PRNT,
        KO_HM,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KO_BS,   XXXXXXX, KO_ED,   KO_TB,   KO_CTLO,
        SW_OS,   XXXXXXX, KO_CMDD, KO_DL,   KO_AR,   XXXXXXX, XXXXXXX, KO_CTLK, KO_EN,   XXXXXXX, KO_JIS,  ADJUST2,
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KO_CMSP, XXXXXXX, XXXXXXX, MT_SPC,  KO_MTAB, LT_FNC,  XXXXXXX, XXXXXXX
    ), // }}}

    [_ADJUST2] = LAYOUT_planck_grid( // {{{
        EXT_LYR, QK_BOOT, DB_TOGG, KO_SWIT, AU_TOGG, XXXXXXX, XXXXXXX, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,
        XXXXXXX, FPS,     QWERTY,  COLEMAK, XXXXXXX, XXXXXXX, XXXXXXX, RGB_M_P, RGB_M_B, RGB_M_R, RGB_M_SW,RGB_M_SN,
        EE_CLR,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_M_K, RGB_M_X, RGB_M_G, RGB_M_T, RGB_M_TW,
    ...
    [_FPS] = LAYOUT_planck_grid( // {{{
        _______, _______, _______, _______, _______, _______, EXT_LYR, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
