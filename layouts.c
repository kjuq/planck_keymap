const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FNCTN] = LAYOUT_planck_grid( // {{{
        XXXXXXX, KC_VOLU, DM_RSTP, KC_F15,  ADJUST,  XXXXXXX, XXXXXXX, KC_F12,  KC_F7,   KC_F8,   KC_F9,   XXXXXXX,
        HOLDLST, KC_MPLY, DM_REC1, KC_F14,  KC_F17,  XXXXXXX, XXXXXXX, KC_F11,  KC_F4,   KC_F5,   KC_F6,   MODS,
        XXXXXXX, KC_VOLD, DM_PLY1, KC_F13,  KC_F16,  XXXXXXX, XXXXXXX, KC_F10,  KC_F1,   KC_F2,   KC_F3,   ORS,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ), // }}}
